...
#define TEST_DEVICE_NAME            "Nhom_7-Lop_2"
...
static void gatts_profile_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_REG_EVT:
        ...
        app_profile.service_id.id.uuid.uuid.uuid16 = GATTS_SERVICE_UUID_TEST;
        ...
        esp_ble_gatts_create_service(gatts_if, &app_profile.service_id, GATTS_NUM_HANDLE_TEST);
        break;
    ...
    case ESP_GATTS_WRITE_EVT: {
        ...
        if (!param->write.is_prep){
            ...
            if (app_profile.descr_handle == param->write.handle && param->write.len == 2){
                ...
                if (descr_value == 0x0001){
                    if (char_property & ESP_GATT_CHAR_PROP_BIT_NOTIFY){
                        ...
                        esp_ble_gatts_send_indicate(gatts_if, param->write.conn_id, app_profile.char_handle,
    ...
    case ESP_GATTS_CREATE_EVT:
        ...
        app_profile.char_uuid.uuid.uuid16 = GATTS_CHAR_UUID_TEST;
        ...
        esp_err_t add_char_ret = esp_ble_gatts_add_char(app_profile.service_handle, &app_profile.char_uuid,
    ...
    case ESP_GATTS_ADD_CHAR_EVT: {
        ...
        app_profile.descr_uuid.len = ESP_UUID_LEN_16;
        app_profile.descr_uuid.uuid.uuid16 = ESP_GATT_UUID_CHAR_CLIENT_CONFIG;
        ...
        esp_err_t add_descr_ret = esp_ble_gatts_add_char_descr(app_profile.service_handle, &app_profile.descr_uuid,
    ...
    case ESP_GATTS_ADD_CHAR_DESCR_EVT:
        app_profile.descr_handle = param->add_char_descr.attr_handle;
...
static void gatts_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param)
{
    ...
    /* If the gatts_if equal to app profile, call app profile cb handler,
     * so here call each profile's callback */
    if (gatts_if == ESP_GATT_IF_NONE || /* ESP_GATT_IF_NONE, not specify a certain gatt_if, need to call every profile cb function */
            gatts_if == app_profile.gatts_if) {
